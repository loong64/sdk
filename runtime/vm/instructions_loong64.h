...
class PcRelativePatternBase : public ValueObject {
 public:
  ...
  int32_t distance() {
    ...
    int32_t offs16 = static_cast<int16_t>((jirl >> 10) & 0xffff);
    return (si20 << 12) + (offs16 << 2);
  }
