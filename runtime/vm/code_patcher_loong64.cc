...
class PoolPointerCall : public ValueObject {
 public:
  PoolPointerCall(uword pc, const Code& code)
    ...
    // JIRL instruction encoding: 0x4c000020 = JIRL rd=0, rj=1, offs16=0
    ASSERT(*reinterpret_cast<uint32_t*>(end_ - 4) == 0x4c000020);
    InstructionPattern::DecodeLoadWordFromPool(end_ - 12, &reg_, &index_);
  }
